...
Credits go the developers who built the used libraries. Usually these are developed by teams, so you can have a look at the developers from the links in [LANGUAGES AND LIBRARIES](#languages-and-libraries).
